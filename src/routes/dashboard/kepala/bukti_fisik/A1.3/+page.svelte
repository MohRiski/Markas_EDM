        ...
        <tbody class="text-sm">
          {#each JDarray as j}
            <tr class="border-t hover:bg-gray-50">
                <td class="px-4 py-2 text-[12px]">{j.bulan}</td>
                <td class="px-4 py-2 text-[12px]">{j.kelas}</td>              
                <td class="px-4 py-2 text-[12px]">{j.jumlah}</td>
                <td class="px-4 py-2 text-[12px]">{j.melanggar}</td>              
                <td class="px-4 py-2 text-[12px]">{Math.round(j.prosentase)} %</td>
                <td class="px-4 py-2 text-[12px]">{j.keterangan}</td>
            </tr>
          {/each}
        </tbody>
    </table> 
