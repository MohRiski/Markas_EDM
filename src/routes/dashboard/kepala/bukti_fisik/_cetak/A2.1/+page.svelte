            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="9">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px] mb-3">REKAPITULASI DAFTAR KEHADIRAN GURU DI MADRASAH DALAM MELAKSANAKAN KEGIATAN PEMBELAJARAN, PEMBIMBINGAN, DAN PELATIHAN SESUAI JADWAL</p>
                                <div class="flex">
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th rowspan="2" class="px-2 py-1 border-r border-black">Jumlah Guru</th>
                        <th rowspan="2" class="px-2 py-1 border-r border-black">Wajib Hadir</th>
                        <th colspan="4" class="px-2 py-1 w-[30%] border-r border-black">Jumlah Absen</th>
                        <th rowspan="2" class="px-2 py-1 border-r border-black">Prosentase (%)</th>
                        <th rowspan="2" class="px-2 py-1 w-[20%] border-r border-black">Keterangan</th>
                    </tr>
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        <th class="border px-2 py-1 border-r border-black">S</th>
                        <th class="border px-2 py-1 border-r border-black">I</th>
                        <th class="border px-2 py-1 border-r border-black">A</th>
                        <th class="border px-2 py-1 border-r border-black">Jumlah</th>
                    </tr>
                </thead>
                <tbody>
                {#each JDarray as j}
