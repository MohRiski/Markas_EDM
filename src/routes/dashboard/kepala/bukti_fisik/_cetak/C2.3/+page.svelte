            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="9">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px] mb-3">DAFTAR GURU YANG MENGGUNAKAN METODE PEMBELAJARAN YANG SESUAI PADA TAHUN PELAJARAN {currentYear}</p>
                            </div>
                        </td>
                    </tr>
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th rowspan="2" class="border-r border-black px-2 py-1">Mata Pelajaran</th>
                        <th colspan="2" class="border-r border-black px-2 py-1">X</th>
                        <th colspan="2" class="border-r border-black px-2 py-1">XI</th>
                        <th colspan="2" class="border-r border-black px-2 py-1">XII</th>
                    </tr>
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        <th class="border-r border-black px-2 py-2">S</th>
                        <th class="border-r border-black px-2 py-2">TS</th>
                        <th class="border-r border-black px-2 py-2">S</th>
                        <th class="border-r border-black px-2 py-2">TS</th>
                        <th class="border-r border-black px-2 py-2">S</th>
                        <th class="border-r border-black px-2 py-2">TS</th>
                        ...
                        <td colspan="9">
                            <div class="mt-4 mr-2 ml-2 text-[12px] text-right">
                                ...
                                <div class="flex justify-between">
                                    <div class="text-left">
                                        <p class="pb-1 font-bold">Catatan:</p>
                                        <p class="italic font-semibold">S: Sesuai</p>
                                        <p class="italic font-semibold">TS: Tidak Sesuai</p>
                                    </div>
                                    {#if status === 'Diterima'}
