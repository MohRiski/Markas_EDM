            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px] mb-3">DAFTAR GURU YANG MENGGUNAKAN ALAT PERAGA YANG SESUAI</p>
                                <div class="flex">
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th class="border-r border-black px-4 py-2">Nama Guru</th>
                        <th class="border-r border-black px-4 py-2">Pengampu Mapel/Kelas</th>
                        <th class="border-r border-black px-4 py-2">Jenis Alat Bantu/Media Yang Dipakai</th>
                        <th class="border-r border-black px-4 py-2">Cara Peroleh</th>
                        <th class="border-r border-black px-4 py-2">Banyaknya</th>
                        <th class="border-r border-black px-4 py-2">Keterangan</th>
                    </tr>
                </thead>
                <tbody>
                {#each JDarray as j,i}
                    <tr class="border border-black text-center">
                        <td class="px-4 py-2 text-[12px] border-r border-black">
                           {i+1}
                        </td>
                        <td class="px-4 py-2 text-[12px] border-r border-black">
                           {j.nama}
