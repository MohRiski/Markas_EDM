    ...
    async function simpan() {
        ...
        if (!id_input_bukti_fisik) {
            ...
            if (res.ok) {
                ...
                goto('/dashboard/keuangan/bukti_fisik/A6.3');
            } else {
                Swal.fire({
                    title: 'Gagal!',
...
<div class="flex justify-end gap-2 mt-2 mr-2 text-[10px] font-semibold">
    <button on:click={()=> goto('/dashboard/keuangan/bukti_fisik/A6.3')} class="px-2 py-1 rounded-md bg-white border-2 border-red-400 hover:bg-red-600 hover:text-white">Kembali</button>
