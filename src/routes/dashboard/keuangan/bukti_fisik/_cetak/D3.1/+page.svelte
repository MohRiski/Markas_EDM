            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px] mb-3">DAFTAR INVENTARIS MEDIA TIK YANG TERSEDIA DI MADRASAH</p>
                                <div class="flex">
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th rowspan="2" class="border-r border-black px-2 py-1">Nama Alat/Bahan</th>
                        <th rowspan="2" class="border-r border-black px-2 py-1">Jumlah</th>
                        <th colspan="2" class="border-r border-black px-2 py-1">Kodisi</th>
                        <th rowspan="2" class="border-r border-black px-2 py-1">Keterangan</th>
                    </tr>
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        <th class="border-r border-black px-2 py-2">Baik</th>
                        <th class="border-r border-black px-2 py-2">Rusak</th>
                    </tr>
                </thead>
                <tbody>
                {#each JDarray as j, i}
