            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="8">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px] mb-3">DAFTAR GURU YANG MEMBUAT PERENCANAAN PROGRAM REMEDIAL, PENGAYAAN DAN KONSELING</p>
                                <div class="flex">
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th rowspan="2" class="border-r border-black px-2 py-1">Mapel</th>
                        <th rowspan="2" class="border-r border-black px-2 py-1">Kelas</th>
                        <th colspan="3" class="border-r border-black px-2 py-1">Program</th>
                        <th rowspan="2" class="border-r border-black px-2 py-1">Keterangan</th>
                    </tr>
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        <th class="border-r border-black px-2 py-2">Remedial</th>
                        <th class="border-r border-black px-2 py-2">Pengayaan</th>
                        <th class="border-r border-black px-2 py-2">Konseling</th>
                    </tr>
                </thead>
                <tbody>
                {#each JDarray as j, i}
