            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="9">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px] mb-3">REKPITULASI DAFTAR PENUGASAN GURU/TENAGA KEPENDIDIKAN</p>
                                <div class="flex">
                                    <p class="">Nama Madrasah</p>
                                    <p class="pl-3">: {namaSekolah}</p>
                                </div>
                                <div class="flex">
                                    <p class="pr-4">NSM/NPSN</p>
                                    <p class="pl-3.5">: 131 235 290 122/{npsn}</p>
                                </div>
                                <div class="flex">
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th rowspan="2" class="px-2 py-1 border-r border-black">Nama Guru/NIP</th>
                        <th rowspan="2" class="px-2 py-1 border-r border-black">Gol Ruang</th>
                        <th rowspan="2" class="px-2 py-1 border-r border-black">TMT</th>
                        <th rowspan="2" class="px-2 py-1 border-r border-black">Jabatan/Tugas Mengajar</th>
                        <th colspan="3" class="px-2 py-1 w-[20%] border-r border-black">Distribusi Jam Per Kelas</th>
                        <th rowspan="2" class="px-2 py-1 w-[5%]">Jumlah Jam Mengajar</th>
                    </tr>
                    <tr  class="text-center border border-black text-[13px] font-semibold">
                        <th class="px-2 py-1 border-r border-black">X</th>
                        <th class="px-2 py-1 border-r border-black">XI</th>
                        <th class="px-2 py-1 border-r border-black">XII</th>
                    </tr>
                </thead>
                <tbody>
                {#each JDarray as j,i}
