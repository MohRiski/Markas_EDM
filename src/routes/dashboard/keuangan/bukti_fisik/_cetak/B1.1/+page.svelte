            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="mt-3 mb-3 text-[12px]">
                                <p class="text-center font-semibold text-[14px]">REKAPITULASI DAFTAR GURU YANG AKTIF MENGIKUTI KEGIATAN PELATIHAN/WORKSHOP</p>
                                <p class="text-center font-semibold text-[14px]">MADRASAH ALIYAH AL-GHAZALI</p>
                                <p class="text-center font-semibold text-[14px] mb-2">TAHUN {currentYear}</p>
                                <div class="flex">
                                    <p class="">Nama Madrasah</p>
                                    <p class="pl-3">: {namaSekolah}</p>
                                </div>
                                <div class="flex">
                                    <p class="pr-2">NSM/NPSN</p>
                                    <p class="pl-6">: 131 235 290 122/{npsn}</p>
                                </div>
                                <div class="flex">
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                            ...
                            <th colspan="3" class="border-r border-black px-2 py-1 w-[50%]">Jenis PKB Yang Aktif Diikuti Guru</th>
                            <th colspan="2" class="border-r border-black px-2 py-1 w-[20%]">Keterangan</th>
                        </tr>
                        <tr class="text-center border border-black text-[13px] font-semibold">
                            <th class="border-r border-black px-2 py-1">Pengembangan Diri</th>
                            <th class="border-r border-black px-2 py-1">Publikasi Ilmiah</th>
                            <th class="border-r border-black px-2 py-1">Karya Inovasi</th>
                            <th class="border-r border-black px-2 py-1">Ya</th>
                            <th class="border-r border-black px-2 py-1">Tidak</th>
                        </tr>
                </thead>
                <tbody>
                {#each JDarray as j,i}
