            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px]">REKAPITULASI DAFTAR GURU DAN BUKU YANG DIGUNAKAN UNTUK PEMBELAJARAN</p>
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th class="border-r border-black px-4 py-2">Mapel</th>
                        <th class="border-r border-black px-4 py-2">Buku Yang Digunakan</th>
                    </tr>
                </thead>
                <tbody class="text-sm">
                {#each JDarray as j, i}
