...
<div class="overflow-x-auto overflow-y-auto border rounded-md shadow bg-white ml-2 mr-2 mb-2 mt-2 max-h-[80%] overflow:rounded-r-md">
    <table class="min-w-[1000px]  w-full table-auto">
        <thead class="bg-gray-100 text-left text-[13px] font-semibold">
          <tr>
            <th class="px-4 py-2 w-[20%]">Bulan</th>
            <th class="px-4 py-2 w-[20%]">Kelas</th>
            <th class="px-4 py-2 w-[15%]">Jumlah Peserta Didik</th>
            <th class="px-4 py-2 w-[15%]">Jumlah Siswa Yang Melanggar</th>
            <th class="px-4 py-2 w-[15%]">Prosentase (%)</th>
            <th class="px-4 py-2 w-[15%]">Keterangan</th>
          </tr>
        </thead>
        <tbody class="text-sm">
          {#each JDarray as j}
            <tr class="border-t hover:bg-gray-50">
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="kelas" bind:value={j.kelas} class="w-full h-6 border px-1 rounded">
                ...
                <td class="px-2 py-2 text-[12px]">
                    <input type="number" id="jumlah" bind:value={j.jumlah} class="w-full h-6 border px-1 rounded" />
                </td>
                <td class="px-2 py-2 text-[12px]">
                    <input type="number" id="melanggar" bind:value={j.melanggar} class="w-full h-6 border px-1 rounded" />
                </td>              
                <td class="px-2 py-2 text-[12px]">
                    <input type="number" disabled step="0.01" id="prosentase" bind:value={j.prosentase} class="w-full h-6 border px-1 rounded" />
                </td>
                <td class="px-2 py-2 text-[12px]">
