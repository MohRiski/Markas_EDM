<script lang="ts">
        ...
        if (res.ok) {
            ...
            if (result.success && result.data) {
                ...
                const draft = draftData.jawaban_bukti_fisik[0]?.detail_jawaban.find(
                    (d: { atribut: string; }) => d.atribut === 'C2.3 Rekapitulasi daftar guru yang menggunakan ragam metode'
                );
                if (draft) {
    ...
    async function simpanSementara() {
        const payload = {
            ...
            jawaban: [
                {
                    atribut: 'C2.3 Rekapitulasi daftar guru yang menggunakan ragam metode',
    ...
    <table class="min-w-[1000px]  w-full table-auto">
        <thead class="bg-gray-100 text-left text-[13px] font-semibold">
            <tr>
                ...
                <th rowspan="2" class="border px-2 py-1">Mata Pelajaran</th>
                <th colspan="2" class="border px-2 py-1">X</th>
                <th colspan="2" class="border px-2 py-1">XI</th>
                <th colspan="2" class="border px-2 py-1">XII</th>
            </tr>
            <tr>
                <th class="border px-2 py-2">S</th>
                <th class="border px-2 py-2">TS</th>
                <th class="border px-2 py-2">S</th>
                <th class="border px-2 py-2">TS</th>
                <th class="border px-2 py-2">S</th>
                <th class="border px-2 py-2">TS</th>
        ...
        <tbody class="text-sm">
          {#each JDarray as j}
            <tr class="border-t hover:bg-gray-50">
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.satuS} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.satuTS} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.duaS} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.duaTS} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.tigaS} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.tigaTS} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
