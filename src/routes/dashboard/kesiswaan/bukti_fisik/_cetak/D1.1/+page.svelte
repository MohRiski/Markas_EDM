            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px] mb-3">DAFTAR BUKU TEKS DAN CETAKAN</p>
                                <div class="flex">
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th class="border-r border-black px-4 py-2">Judul Buku</th>
                        <th class="border-r border-black px-4 py-2">Pengarang</th>
                        <th class="border-r border-black px-4 py-2">Kelas</th>
                        <th class="border-r border-black px-4 py-2">Jumlah</th>
