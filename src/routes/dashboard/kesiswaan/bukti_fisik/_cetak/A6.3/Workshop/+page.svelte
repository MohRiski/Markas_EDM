            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="8">
                            <div class="mt-3 mb-3 text-[12px]">
                                <p class="text-center font-semibold text-[14px]">REKAPITULASI KEAKTIFAN GURU DALAM PELATIHAN/WORKSHOP</p>
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th class="border-r border-black px-2 py-1">Nama Guru/NIP</th>
                        <th class="border-r border-black px-2 py-1">Jenis Kegiatan</th>
                        <th class="border-r border-black px-2 py-1">Penyelenggara</th>
                        <th class="border-r border-black px-2 py-1">Pelaksanaan</th>
                        <th class="border-r border-black px-2 py-1">Waktu</th>
                        <th class="border-r border-black px-2 py-1">Hasil</th>
...
<div class="flex justify-end gap-2 mt-2 mr-2 text-[10px] font-semibold">
    <button on:click={()=> goto('/dashboard/kesiswaan/bukti_fisik/_cetak/A6.3')} class="px-2 py-1 rounded-md bg-white border-2 border-red-400 hover:bg-red-600 hover:text-white">Kembali</button>
</div>
