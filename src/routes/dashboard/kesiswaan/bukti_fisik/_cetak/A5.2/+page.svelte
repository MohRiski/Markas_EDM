<script lang="ts">
    ...
    function TanggalIndo(dateInput: Date | string): string {
        const bulanIndo = [
            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="9">
                            <div class="mt-3 mb-3 text-[12px]">
                                <p class="text-center font-semibold text-[14px]">DAFTAR PEMINJAM BUKU PERPUSTAKAAN</p>
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th rowspan="2" class="px-2 py-1 w-[15%] border-r border-black">Tanggal Peminjaman</th>
                        <th rowspan="2" class="px-2 py-1 border-r border-black">Nama Peminjam</th>
                        <th rowspan="2" class="px-2 py-1 border-r border-black">Judul Buku</th>
                        <th rowspan="2" class="px-2 py-1 border-r border-black">Kategori Buku</th>
                        <th rowspan="2" class="px-2 py-1 border-r border-black">Banyak Buku</th>
                        <th rowspan="2" class="px-2 py-1 w-[15%] border-r border-black">Tanggal Pengembalian</th>
                        <th colspan="2" class="px-2 py-1 border-r border-black">Tanda Tangan</th>
                    </tr>
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        <th class="px-2 py-1 border-r border-black">Peminjaman</th>
                        <th class="px-2 py-1">Pengembalian</th>
                    </tr>
                </thead>
                <tbody>
                {#each JDarray as j, i}
