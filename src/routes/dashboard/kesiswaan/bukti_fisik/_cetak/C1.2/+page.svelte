            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px] mb-3">REKAPITULASI DAFTAR GURU YANG MENGGUNAKAN PERANGKAT PEMBELAJARAN</p>
                                <div class="flex">
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        <th class="border-r border-black px-2 py-2">No</th>
                        <th class="border-r border-black px-2 py-2">Nama Guru</th>
                        <th class="border-r border-black px-2 py-2">Pengampu Mapel/Kelas</th>
                        <th class="border-r border-black px-2 py-2">Kelas</th>
