            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px]">DAFTAR GURU YANG MENGGUNAKAN BUKU TEKS ATAU BUKU DIGITAL DALAM PROSES PEMBELAJARAN</p>
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th colspan="2" class="border-r border-black px-2 py-1">Jenis Buku Yang Digunakan</th>
                    </tr>
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        <th class="border-r border-black px-2 py-2">Teks</th>
                        <th class="border-r border-black px-2 py-2">Digital</th>
                    </tr>
                </thead>
                <tbody>
                {#each JDarray as j,i}
