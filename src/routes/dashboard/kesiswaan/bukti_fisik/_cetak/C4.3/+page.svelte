            ...
            <table class="w-full table-auto" id="tabel-cetak">
                <thead>
                    ...
                    <tr>
                        <td colspan="11">
                            <div class="mt-3 mb-2 text-[12px]">
                                <p class="text-center font-semibold text-[14px] mb-3">DAFTAR GURU YANG MENGGUNAKAN PENILAIAN OTENTIK DALAM PROSES PEMBELAJARAN</p>
                                <div class="flex">
                    ...
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        ...
                        <th rowspan="2" class="border-r border-black px-2 py-1">Pengampu Mapel</th>
                        ...
                        <th colspan="4" class="border-r border-black px-2 py-1">Bentuk Penilaian</th>
                    </tr>
                    <tr class="text-center border border-black text-[13px] font-semibold">
                        <th class="border-r border-black px-2 py-2">1</th>
                        <th class="border-r border-black px-2 py-2">2</th>
                        <th class="border-r border-black px-2 py-2">Spritual</th>
                        <th class="border-r border-black px-2 py-2">Sosial</th>
                        <th class="border-r border-black px-2 py-2">Pengetahuan</th>
                        <th class="border-r border-black px-2 py-2">Keterampilan</th>
                    </tr>
                </thead>
                <tbody>
                {#each JDarray as j,i}
