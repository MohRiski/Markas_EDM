<script lang="ts">
        ...
        if (res.ok) {
            ...
            if (result.success && result.data) {
                ...
                const draft = draftData.jawaban_bukti_fisik[0]?.detail_jawaban.find(
                    (d: { atribut: string; }) => d.atribut === 'C4.3 Daftar guru yang melakukan penilaian otentik dalam proses pembelajaran'
                );
                if (draft) {
    ...
    async function simpanSementara() {
        const payload = {
            ...
            jawaban: [
                {
                    atribut: 'C4.3 Daftar guru yang melakukan penilaian otentik dalam proses pembelajaran',
...
<div class="overflow-x-auto overflow-y-auto border rounded-md shadow bg-white ml-2 mr-2 mb-2 mt-2 max-h-[80%] overflow:rounded-r-md">
    <table class="min-w-[1000px]  w-full table-auto">
        <thead class="bg-gray-100 text-left text-[13px] font-semibold">
            <tr>
                <th rowspan="2" class="border px-2 py-1">Nama Guru</th>
                <th rowspan="2" class="border px-2 py-1">Pengampu Mapel</th>
                <th colspan="2" class="border px-2 py-1">Semester</th>
                <th rowspan="2" class="border px-2 py-1">Kelas</th>
                <th rowspan="2" class="border px-2 py-1">RPP</th>
                <th colspan="4" class="border px-2 py-1">Bentuk Penilaian</th>
            </tr>
            <tr>
                <th class="border px-2 py-2">1</th>
                <th class="border px-2 py-2">2</th>
                <th class="border px-2 py-2">Spritual</th>
                <th class="border px-2 py-2">Sosial</th>
                <th class="border px-2 py-2">Pengetahuan</th>
                <th class="border px-2 py-2">Keterampilan</th>
            </tr>
        </thead>
        <tbody class="text-sm">
          {#each JDarray as j}
            <tr class="border-t hover:bg-gray-50">
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.satu} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.dua} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.rpp} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.spritual} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.sosial} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.pengetahuan} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
                ...
                <td class="px-2 py-2 text-[12px]">
                    <select id="bulan" bind:value={j.keterampilan} class="w-full h-6 border px-1 rounded">
                        <option value=""></option>
                        <option value="✓">✓</option>
                        <option value="X">X</option>
                    </select>
