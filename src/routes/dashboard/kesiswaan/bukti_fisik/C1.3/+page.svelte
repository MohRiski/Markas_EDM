<script lang="ts">
    ...
    async function simpanSementara() {
        const payload = {
            ...
            jawaban: [
                {
                    atribut: 'Daftar guru yang menyusun Perangkat Pembelajaran',
        ...
        <tbody class="text-sm">
          {#each JDarray as j}
            <tr class="border-t hover:bg-gray-50">
                ...
                <td class="px-2 py-2 text-[12px]">
                    <input type="text" min="0" id="jumlah" bind:value={j.metode} class="w-full h-6 border px-1 rounded" />
                </td>
                <td class="px-2 py-2 text-[12px]">
                    <input type="text" min="0" id="jumlah" bind:value={j.media} class="w-full h-6 border px-1 rounded" />
                </td>                                                               
                <td class="px-2 py-2 text-[12px]">
                    <input type="text" min="0" id="jumlah" bind:value={j.penilaian} class="w-full h-6 border px-1 rounded" />
                </td>                                                               
            </tr>
          {/each}
        </tbody>
